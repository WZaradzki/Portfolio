    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="">
        <h2
          ...
          "
        >
          <span v-if="lang == 'PL'"> Czym się zajmuje? </span>
          <span v-else> What i do? </span>
        </h2>
      </div>
          ...
          <div v-for="tool in activityLang" :key="tool.name" class="relative">
            <dt>
              <div
                ...
                "
              >
                <span class="h-full flex items-center justify-center w-full plaster-font uppercase text-4xl text-center">{{ tool.icon }}</span>
              </div>
              <p
                class="
                  ml-16
