...
<body bgcolor="#F5F8FA"
    style="width: 100% !important; margin: auto 0; padding:0; font-family:Nunito Sans, sans-serif; font-size:18px; color:#33475B; word-break:break-word">
            ...
            <! Banner -->
                <table role="presentation" width="100%">
                    <tr>
                        ...
                        <td bgcolor="#ffd369" align="center" style="color: white;">
                            ...
                            <img alt="Logo" src="{{ asset('/storage/assets/logo/logo.png') }}" width="400px"
                                align="middle">

                            <h1 style="font-size: 2.4rem; color:#222831;">Cześć {{ $contact->name_surname }}!</h1>
                ...
                <! First Row -->
                    ...
                    <table role=" presentation" border="0" cellpadding="0" cellspacing="10px"
                        ...
                        <tr>
                            <td>
                                <h2>Dziękuje za kontakt,</h2>
                                <p>
                                    zwykle odpowiadam do 24 godzin.
                                    do usłyszenia
                                </p>
                                <a class="a-link" href="{{ config('app.url') }}">
                                    Wroć na strone
                                </a>
                            </td>
                        </tr>
